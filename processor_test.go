...
func TestProcessor(t *testing.T) {
	...
	doGoldenTests(t, filepath.Join(testDataDir, "golden/result"), []test{
		...
		{name: "mp4", path: "fit-in/200x100/schizo_0.mp4"},
		{name: "mp4 orient 90", path: "fit-in/220x100/schizo_90.mp4"},
		{name: "mp4 orient 180", path: "fit-in/200x100/schizo_180.mp4"},
		{name: "mp4 orient 270", path: "fit-in/200x100/schizo_270.mp4"},
